...
{
    public partial class CreateUserBlogCommentTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogBook", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlogBook_Blog_BlogId",
                        column: x => x.BlogId,
                        principalTable: "Blog",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BlogBook_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentsTable = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBookComment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserBookComment_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserBookComment_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBookOrder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserBookOrder_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserBookOrder_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserBookOrder_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogBook_BlogId",
                table: "BlogBook",
                column: "BlogId");

            migrationBuilder.CreateIndex(
                name: "IX_BlogBook_BookId",
                table: "BlogBook",
                column: "BookId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBookComment_AppUserId",
                table: "UserBookComment",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookComment_BookId",
                table: "UserBookComment",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookOrder_AppUserId",
                table: "UserBookOrder",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookOrder_BookId",
                table: "UserBookOrder",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookOrder_OrderId",
                table: "UserBookOrder",
                column: "OrderId");
        }
